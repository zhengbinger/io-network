...
public class PioClient {
    ...
    public static void send(int port,String expression){
        System.out.println("伪异步IO客户端表达式为："+expression);
        Socket socket = null;
        ...
        try{
            ...
            System.out.println("伪异步IO结果为："+in.readLine());
        }catch (IOException e){
            e.printStackTrace();
        }finally {
    ...
    public static void main(String[] args) {
        ...
        String expression = random.nextInt(10)+oprate+(random.nextInt(10)+1);
        PioClient.send(expression);
    }
}
